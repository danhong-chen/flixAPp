...
//  flisterApp
//
//  Created by Vivian Chen on 9/11/21.
//

import UIKit
import AlamofireImage

//step1: add UITableViewDataSource,UITableViewDelegate
//step2: move the 2 method to bottom and then add return value
class MoviesViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let indexPath = tableView.indexPath(for: cell)! //what is the index
